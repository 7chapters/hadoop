...
public class MyPart {
	...
	public static class MyPartitioner implements Partitioner<Text, IntWritable> {
		...
		public int getPartition(Text key, IntWritable value, int numPartitions) {
			...
			if (myKey.equals("warn")|| myKey.equals("learning")|| myKey.equals("program")) {
				return 0;
			}
			if (myKey.equals("2014")) {
				return 1;
			}
			else {
				return 2;
	...
	public static void main(String[] args) throws Exception {
		...
		JobConf conf = new JobConf(MyPart.class);
		...
		FileOutputFormat.setOutputPath(conf, new Path(args[1]+"/"+new Date()));
